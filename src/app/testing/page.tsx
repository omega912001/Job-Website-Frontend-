...
import { updateCarousel, prevSlide, nextSlide } from "../../scripts/script";

export default function Details() {
  const [currentIndex, setCurrentIndex] = useState(0);

  useEffect(() => {
    // Update the carousel position on index change
    updateCarousel(currentIndex);
  }, [currentIndex]);

  const handlePrev = () => {
    const slidesLength =
      document.querySelector("#carousel")?.children.length || 0;
    setCurrentIndex(prevSlide(currentIndex, slidesLength));
  };

  const handleNext = () => {
    const slidesLength =
      document.querySelector("#carousel")?.children.length || 0;
    setCurrentIndex(nextSlide(currentIndex, slidesLength));
  };
    ...
    <>
      ...
      <div className="bg-[#AFDBF3]">
        ...
        <div className="container ">
          ...
          <div className="container  flex  mt-0">
            {/* <!-- DIV 1 --> */}

            <div className="sm:hidden md:hidden lg:block xl:block w-[30%] border-l border-r border-b border-black mx-3 py-0 px-5 h-[600px] overflow-y-auto overflow-x-hidden lg:w-[45%] xl:w-[30%]">
              {/* <!-- card1  --> */}
              <div className="bg-white shadow-md rounded-lg w-80 p-4 border-4  border-blue-500 mt-3">
            ...
            {/* <!-- DIV2 STARTED--> */}
            <div className="w-[50%] p-4 mx-0 border-black bg-white h-[600px] overflow-y-auto sm:w-[100%] md:w-[100%] lg:w-[80%] xl:w-[50%]">
              <div className="flex">
              ...
              <div className="relative w-full overflow-hidden mt-9 sm:block md:block lg:hidden xl:hidden">
                {/* Carousel */}
                <div
                  id="carousel"
                  className="mt-5 flex transition-transform duration-700 items-center md:px-[4rem]"
                >
                  <div className="w-full flex-shrink-0 px-[11.5rem] sm: -ml-[2rem]">
                    <div className="bg-white shadow-md rounded-lg w-80 p-4 border-4  border-blue-500">
                      ...
                      <p className="text-gray-600 mb-4 text-sm leading-tight">
                        Doing the right thing for investors is what we’re all
                        about at Vanguard, and that in...
                      </p>
                      <hr></hr>
                      <div className="flex justify-between items-center mt-2">
                        <div className="text-xl font-bold">$250/hr</div>
                  ...
                  <div className="w-full flex-shrink-0 px-[11.5rem]">
                    <div className="bg-white shadow-md rounded-lg w-80 p-4 border-4  border-blue-500">
                      <div className="flex justify-between items-start mb-4">
                        <div className="flex items-start space-x-2">
                          <img
                ...
                <button
                  onClick={handlePrev}
                  className="absolute top-1/2 left-2 transform -translate-y-1/2 bg-gray-800 text-white px-3 py-2 rounded"
                >
                  Prev
                </button>
                <button
                  onClick={handleNext}
                  className="absolute top-1/2 right-2 transform -translate-y-1/2 bg-gray-800 text-white px-3 py-2 rounded"
                >
                  Next
                </button>
              </div>
            ...
            {/* <!-- DIV3 --> */}
            <div className="w-[20%] border-l border-black bg-white p-4 h-[600px] sm:hidden md:hidden lg:hidden xl:block">
              {/* <!-- box1 --> */}
              <div className="flex">
                <h1 className="text-lg font-semibold">Netflix ,Inc</h1>
                <svg
